...
// localStorage on this device. Not yet localized (deferred to G4) — every
// other page in this app goes through lib/i18n.ts, this one doesn't yet.
...
export default function TablePage() {
  const [code, setCode] = useState<string | null>(() => getStoredGroupCode())
