...
export interface UiStrings {
  ...
  inventory: {
    ...
    removing: string
    addedCopies: (qty: number, count: number) => string
    removedCopies: (qty: number, count: number) => string
