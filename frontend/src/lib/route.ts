...
// #/share/<token>, #/diff, #/seating, #/help, #/about). Deliberately not a
// router library — AGENTS.md requires an ADR for new runtime deps, and this
// many routes still doesn't justify one.
