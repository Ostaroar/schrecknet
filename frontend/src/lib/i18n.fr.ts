...
const fr: UiStrings = {
  ...
  account: {
    ...
    whatItsFor: "Un compte fait une seule chose : il synchronise vos decks et votre inventaire sur un autre appareil, chiffrés de bout en bout avec votre code de récupération pour que SchreckNet ne puisse pas les lire. Tout le reste continue de fonctionner exactement pareil sans lui.",
    ...
    syncIntro: "Chiffrée de bout en bout avec votre code de récupération — SchreckNet ne peut pas la lire. Saisissez votre code une fois par session de navigateur pour déverrouiller la synchronisation.",
    unlockLabel: 'Code de récupération',
    unlockButton: 'Déverrouiller la synchronisation',
    unlocking: 'Déverrouillage…',
    syncNow: 'Synchroniser maintenant',
    syncing: 'Synchronisation…',
    neverSynced: "Rien n'a encore été synchronisé depuis aucun appareil.",
    upToDate: (date) => `À jour — dernière synchronisation le ${date}.`,
    conflictTitle: 'Choisissez les données à conserver',
    conflictIntro: (localDecks, localCards, remoteLabel, remoteDate) =>
      `Cet appareil a ${localDecks} deck${localDecks === 1 ? '' : 's'} et ${localCards} carte${localCards === 1 ? '' : 's'} d'inventaire. Une autre synchronisation existe aussi (${remoteLabel}, ${remoteDate}). Choisissez-en une — l'autre sera écrasée.`,
    keepThisDevice: 'Garder cet appareil, écraser la synchronisation',
    useOtherDevice: "Utiliser l'autre synchronisation, écraser cet appareil",
    lockSync: 'Verrouiller la synchronisation',
    tokensTitle: 'Jetons API',
    tokensNote: "Pour les clients MCP ou REST, qui n'ont ni navigateur ni passkey. Un jeton ne peut que lire/écrire vos données de synchronisation chiffrées — il ne peut pas gérer les passkeys, les jetons, ni supprimer votre compte.",
    loadingTokens: 'Chargement des jetons…',
    createTokenButton: 'Créer un jeton',
    creatingToken: 'Création…',
    tokenCreatedTitle: 'Enregistrez votre nouveau jeton',
    tokenCreatedIntro: "Affiché une seule fois et non récupérable ensuite — enregistrez-le en lieu sûr, par exemple dans un gestionnaire de mots de passe.",
    tokenCreatedContinue: 'Continuer',
    unnamedToken: 'Jeton sans nom',
    revokeToken: 'Révoquer',
    revokingToken: 'Révocation…',
    tokenNicknamePrompt: 'Étiquette pour ce jeton (ex. « client MCP de mon portable »)',
    dangerZoneTitle: 'Zone dangereuse',
    deleteAccountButton: 'Supprimer le compte',
    deletingAccount: 'Suppression…',
    deleteAccountConfirm: "Supprimer définitivement ce compte ? Cette action est irréversible. Vos decks et inventaire locaux dans ce navigateur ne sont pas affectés.",
  },
  settings: {
  ...
  changelog: {
    ...
    entries: [
      { date: '2026-08-04', title: 'Compte optionnel : synchronisez vos decks et votre inventaire', summary: "Connectez-vous avec une passkey pour synchroniser vos decks et votre inventaire entre appareils, chiffré de bout en bout avec votre code de récupération afin que SchreckNet ne puisse pas les lire. Tout continue de fonctionner sans compte.", items: ["Pas de mot de passe, pas d'e-mail — connexion par passkey (Face ID, empreinte digitale ou clé de sécurité), sauvegardée par votre appareil ou gestionnaire de mots de passe.", "La synchronisation est chiffrée côté client ; le serveur ne stocke que le texte chiffré, et les modifications en conflit entre deux appareils sont signalées au lieu d'être écrasées silencieusement.", "Les jetons API permettent d'utiliser les points d'accès de synchronisation MCP/REST depuis d'autres outils, volontairement limités à la synchronisation — ils ne peuvent ni gérer vos passkeys ni supprimer votre compte.", "Supprimez votre compte à tout moment ; il s'agit d'une suppression réelle et définitive, et vos decks locaux restent intacts dans tous les cas."] },
